...
SECRET_KEY = 'f_14ev66t_p5&f!qd1t+&&l8etw3oe^!p$6aopp9erfbtgmvd_'
...
DATABASES_DEFAULT_NAME = os.getenv("DATABASES_DEFAULT_NAME", "citycode")
DATABASES_DEFAULT_HOST = os.getenv("DATABASES_DEFAULT_HOST", "mysql-server-60149727.mysql.database.azure.com")
DATABASES_DEFAULT_PORT = os.getenv("DATABASES_DEFAULT_PORT", "3306")
DATABASES_DEFAULT_USER = os.getenv("DATABASES_DEFAULT_USER", "fy20user@mysql-server-60149727")
DATABASES_DEFAULT_PASSWORD = os.getenv("DATABASES_DEFAULT_PASSWORD", "fy20P@ssw0rd")
